...
func NewABLinker(g *graph.Graph, aManager, aType, bManager, bType string, getMetadata GetMetadata, areLinked AreLinked) probe.Probe {
	...
	innerLinker.getMetadata = getMetadata
